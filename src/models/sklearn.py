...
def inference(lista):
  ...
  BernoulliNB_classifier = load_pickle("data/sklearn/BernoulliNB_classifier_embedded")
  ...
  SGDClassifier_classifier = load_pickle("data/sklearn/SGDClassifier_classifier_embbeded")
  ...
  LogisticRegression_classifier = load_pickle("data/sklearn/LogisticRegression_classifier_embbeded")
  ...
  RandomForest_classifier = load_pickle("data/sklearn/SGDClassifier_classifier_embbeded")
